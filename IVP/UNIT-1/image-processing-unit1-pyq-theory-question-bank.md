...
*   **Answer:**
    ...
    *   **Image Size Calculation:**
        ...
        $$
        $$
        \text{Size in Kilobytes (KB)} = \frac{786,432}{1024} = \mathbf{768 \text{ KB}}
        $$
*   **Concept Explanation:** True color systems represent color pixels as triplets $(R, G, B)$ mapped across three distinct spatial planes in memory. Each channel is quantized to 8 bits ($2^8 = 256$ levels per plane), yielding a total bit depth of $24$ bits per pixel ($2^{24} \approx 16.7$ million possible colors).
...
*   **Answer:**
    ...
    *   **Relationship:** The relationship is exponential:
        ...
        *   **24 BPP:** $2^{24} \approx 16.7$ million colors (True color RGB image, with 8 bits per channel).
